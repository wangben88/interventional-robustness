...
// Note: exceptions have been removed as I can't get the header to work
...
bayesnet* bayesnet::read(const char *infile){
    ...
    try {
        ...
        throw "BayesnetException";//bayesnet_exception("Failed to parse %s (%s)", infile, e.what());
    }
    ...
    try {
        ...
        throw "BayesnetException";//bayesnet_exception("%s", e.what());
    }
    return NULL;
    */
}
