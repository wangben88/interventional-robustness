...
class CalculatorLogE extends Calculator {
  ...
  protected void bubbleUp(
	  ...
	  Evidence ev)
	  throws Exception {
	throw new Exception("LogE bubbleup is not yet supported");
  }

@Override
protected void countTerms(int numNodes, byte[] nodeToType, int[] nodeToLit, int[] nodeToLastEdge, int[] edgeToTailNode,
		int[] nodeToSplitVar, Evidence ev) throws Exception {
